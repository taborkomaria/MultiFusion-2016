/****************************************************************************
** Meta object code from reading C++ file 'Quad.h'
**
...
#include "../../../../../MultiFusion-master/plugins/figurestools/Quad/Quad.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'Quad.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_E_Quad_t {
    QByteArrayData data[3];
    char stringdata[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_E_Quad_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_E_Quad_t qt_meta_stringdata_E_Quad = {
    {
QT_MOC_LITERAL(0, 0, 6), // "E_Quad"
...
static const uint qt_meta_data_E_Quad[] = {
...
void E_Quad::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        E_Quad *_t = static_cast<E_Quad *>(_o);
        switch (_id) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (E_Quad::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&E_Quad::setActive)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject E_Quad::staticMetaObject = {
    { &FigureToolInterface::staticMetaObject, qt_meta_stringdata_E_Quad.data,
      qt_meta_data_E_Quad,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *E_Quad::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *E_Quad::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_E_Quad.stringdata))
        return static_cast<void*>(const_cast< E_Quad*>(this));
    if (!strcmp(_clname, "InterfacePlugin"))
        return static_cast< InterfacePlugin*>(const_cast< E_Quad*>(this));
    if (!strcmp(_clname, "com.Tailer.MultiFusion.FigureToolInterface/1.0"))
        return static_cast< FigureToolInterface*>(const_cast< E_Quad*>(this));
    if (!strcmp(_clname, "com.alxn1.DocWindow.PluginInterface/1.0"))
        return static_cast< InterfacePlugin*>(const_cast< E_Quad*>(this));
    return FigureToolInterface::qt_metacast(_clname);
}

int E_Quad::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void E_Quad::setActive(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
