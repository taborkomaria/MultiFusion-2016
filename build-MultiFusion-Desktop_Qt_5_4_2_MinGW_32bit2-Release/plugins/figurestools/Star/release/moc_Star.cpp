...
#include "../../../../../MultiFusion-master/plugins/figurestools/Star/Star.h"
...
struct qt_meta_stringdata_G_Star_t {
    QByteArrayData data[3];
    char stringdata[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_G_Star_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_G_Star_t qt_meta_stringdata_G_Star = {
    {
QT_MOC_LITERAL(0, 0, 6), // "G_Star"
...
static const uint qt_meta_data_G_Star[] = {
...
void G_Star::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        G_Star *_t = static_cast<G_Star *>(_o);
        switch (_id) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (G_Star::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&G_Star::setActive)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject G_Star::staticMetaObject = {
    { &FigureToolInterface::staticMetaObject, qt_meta_stringdata_G_Star.data,
      qt_meta_data_G_Star,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *G_Star::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *G_Star::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_G_Star.stringdata))
        return static_cast<void*>(const_cast< G_Star*>(this));
    if (!strcmp(_clname, "InterfacePlugin"))
        return static_cast< InterfacePlugin*>(const_cast< G_Star*>(this));
    if (!strcmp(_clname, "com.Tailer.MultiFusion.FigureToolInterface/1.0"))
        return static_cast< FigureToolInterface*>(const_cast< G_Star*>(this));
    if (!strcmp(_clname, "com.alxn1.DocWindow.PluginInterface/1.0"))
        return static_cast< InterfacePlugin*>(const_cast< G_Star*>(this));
    return FigureToolInterface::qt_metacast(_clname);
}

int G_Star::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void G_Star::setActive(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
