...
#include "../../../../../MultiFusion-master/plugins/figurestools/Polygon/Polygon.h"
...
struct qt_meta_stringdata_F_Polygon_t {
    QByteArrayData data[3];
    char stringdata[21];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_F_Polygon_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_F_Polygon_t qt_meta_stringdata_F_Polygon = {
    {
QT_MOC_LITERAL(0, 0, 9), // "F_Polygon"
QT_MOC_LITERAL(1, 10, 9), // "setActive"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "F_Polygon\0setActive\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_F_Polygon[] = {
...
void F_Polygon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        F_Polygon *_t = static_cast<F_Polygon *>(_o);
        switch (_id) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (F_Polygon::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&F_Polygon::setActive)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject F_Polygon::staticMetaObject = {
    { &FigureToolInterface::staticMetaObject, qt_meta_stringdata_F_Polygon.data,
      qt_meta_data_F_Polygon,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *F_Polygon::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *F_Polygon::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_F_Polygon.stringdata))
        return static_cast<void*>(const_cast< F_Polygon*>(this));
    if (!strcmp(_clname, "InterfacePlugin"))
        return static_cast< InterfacePlugin*>(const_cast< F_Polygon*>(this));
    if (!strcmp(_clname, "com.Tailer.MultiFusion.FigureToolInterface/1.0"))
        return static_cast< FigureToolInterface*>(const_cast< F_Polygon*>(this));
    if (!strcmp(_clname, "com.alxn1.DocWindow.PluginInterface/1.0"))
        return static_cast< InterfacePlugin*>(const_cast< F_Polygon*>(this));
    return FigureToolInterface::qt_metacast(_clname);
}

int F_Polygon::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void F_Polygon::setActive(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
