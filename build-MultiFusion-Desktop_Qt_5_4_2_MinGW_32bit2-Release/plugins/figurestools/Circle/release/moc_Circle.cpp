...
#include "../../../../../MultiFusion-master/plugins/figurestools/Circle/Circle.h"
...
struct qt_meta_stringdata_C_Circle_t {
    QByteArrayData data[3];
    char stringdata[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_C_Circle_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_C_Circle_t qt_meta_stringdata_C_Circle = {
    {
QT_MOC_LITERAL(0, 0, 8), // "C_Circle"
QT_MOC_LITERAL(1, 9, 9), // "setActive"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "C_Circle\0setActive\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_C_Circle[] = {
...
void C_Circle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        C_Circle *_t = static_cast<C_Circle *>(_o);
        switch (_id) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (C_Circle::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&C_Circle::setActive)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject C_Circle::staticMetaObject = {
    { &FigureToolInterface::staticMetaObject, qt_meta_stringdata_C_Circle.data,
      qt_meta_data_C_Circle,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *C_Circle::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *C_Circle::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_C_Circle.stringdata))
        return static_cast<void*>(const_cast< C_Circle*>(this));
    if (!strcmp(_clname, "InterfacePlugin"))
        return static_cast< InterfacePlugin*>(const_cast< C_Circle*>(this));
    if (!strcmp(_clname, "com.Tailer.MultiFusion.FigureToolInterface/1.0"))
        return static_cast< FigureToolInterface*>(const_cast< C_Circle*>(this));
    if (!strcmp(_clname, "com.alxn1.DocWindow.PluginInterface/1.0"))
        return static_cast< InterfacePlugin*>(const_cast< C_Circle*>(this));
    return FigureToolInterface::qt_metacast(_clname);
}

int C_Circle::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void C_Circle::setActive(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
