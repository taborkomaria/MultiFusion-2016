/****************************************************************************
** Meta object code from reading C++ file 'PolyChain.h'
**
...
#include "../../../../../MultiFusion-master/plugins/figurestools/PolyChain/PolyChain.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'PolyChain.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_X_PolyChain_t {
    QByteArrayData data[3];
    char stringdata[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_X_PolyChain_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_X_PolyChain_t qt_meta_stringdata_X_PolyChain = {
    {
QT_MOC_LITERAL(0, 0, 11), // "X_PolyChain"
QT_MOC_LITERAL(1, 12, 9), // "setActive"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "X_PolyChain\0setActive\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_X_PolyChain[] = {
...
void X_PolyChain::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        X_PolyChain *_t = static_cast<X_PolyChain *>(_o);
        switch (_id) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (X_PolyChain::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&X_PolyChain::setActive)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject X_PolyChain::staticMetaObject = {
    { &FigureToolInterface::staticMetaObject, qt_meta_stringdata_X_PolyChain.data,
      qt_meta_data_X_PolyChain,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *X_PolyChain::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *X_PolyChain::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_X_PolyChain.stringdata))
        return static_cast<void*>(const_cast< X_PolyChain*>(this));
    if (!strcmp(_clname, "InterfacePlugin"))
        return static_cast< InterfacePlugin*>(const_cast< X_PolyChain*>(this));
    if (!strcmp(_clname, "com.Tailer.MultiFusion.FigureToolInterface/1.0"))
        return static_cast< FigureToolInterface*>(const_cast< X_PolyChain*>(this));
    if (!strcmp(_clname, "com.alxn1.DocWindow.PluginInterface/1.0"))
        return static_cast< InterfacePlugin*>(const_cast< X_PolyChain*>(this));
    return FigureToolInterface::qt_metacast(_clname);
}

int X_PolyChain::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void X_PolyChain::setActive(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
