...
#include "../../../../../MultiFusion-master/plugins/figurestools/PenTool/PenTool.h"
...
struct qt_meta_stringdata_A_Pen_t {
    QByteArrayData data[3];
    char stringdata[17];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_A_Pen_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_A_Pen_t qt_meta_stringdata_A_Pen = {
    {
QT_MOC_LITERAL(0, 0, 5), // "A_Pen"
QT_MOC_LITERAL(1, 6, 9), // "setActive"
...
static const uint qt_meta_data_A_Pen[] = {
...
void A_Pen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        A_Pen *_t = static_cast<A_Pen *>(_o);
        switch (_id) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (A_Pen::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&A_Pen::setActive)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject A_Pen::staticMetaObject = {
    { &FigureToolInterface::staticMetaObject, qt_meta_stringdata_A_Pen.data,
      qt_meta_data_A_Pen,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *A_Pen::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *A_Pen::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_A_Pen.stringdata))
        return static_cast<void*>(const_cast< A_Pen*>(this));
    if (!strcmp(_clname, "InterfacePlugin"))
        return static_cast< InterfacePlugin*>(const_cast< A_Pen*>(this));
    if (!strcmp(_clname, "com.Tailer.MultiFusion.FigureToolInterface/1.0"))
        return static_cast< FigureToolInterface*>(const_cast< A_Pen*>(this));
    if (!strcmp(_clname, "com.alxn1.DocWindow.PluginInterface/1.0"))
        return static_cast< InterfacePlugin*>(const_cast< A_Pen*>(this));
    return FigureToolInterface::qt_metacast(_clname);
}

int A_Pen::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void A_Pen::setActive(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
