...
#include "../../../../../MultiFusion-master/plugins/figurestools/Spline/Spline.h"
...
struct qt_meta_stringdata_H_Spline_t {
    QByteArrayData data[3];
    char stringdata[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_H_Spline_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_H_Spline_t qt_meta_stringdata_H_Spline = {
    {
QT_MOC_LITERAL(0, 0, 8), // "H_Spline"
QT_MOC_LITERAL(1, 9, 9), // "setActive"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "H_Spline\0setActive\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_H_Spline[] = {
...
void H_Spline::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        H_Spline *_t = static_cast<H_Spline *>(_o);
        switch (_id) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (H_Spline::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&H_Spline::setActive)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject H_Spline::staticMetaObject = {
    { &FigureToolInterface::staticMetaObject, qt_meta_stringdata_H_Spline.data,
      qt_meta_data_H_Spline,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *H_Spline::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *H_Spline::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_H_Spline.stringdata))
        return static_cast<void*>(const_cast< H_Spline*>(this));
    if (!strcmp(_clname, "InterfacePlugin"))
        return static_cast< InterfacePlugin*>(const_cast< H_Spline*>(this));
    if (!strcmp(_clname, "com.Tailer.MultiFusion.FigureToolInterface/1.0"))
        return static_cast< FigureToolInterface*>(const_cast< H_Spline*>(this));
    if (!strcmp(_clname, "com.alxn1.DocWindow.PluginInterface/1.0"))
        return static_cast< InterfacePlugin*>(const_cast< H_Spline*>(this));
    return FigureToolInterface::qt_metacast(_clname);
}

int H_Spline::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void H_Spline::setActive(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
