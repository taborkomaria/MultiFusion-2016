/****************************************************************************
** Meta object code from reading C++ file 'ClippingPath.h'
**
...
#include "../../../../../MultiFusion-master/plugins/figurestools/ClippingPath/ClippingPath.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'ClippingPath.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_J_ClippingPath_t {
    QByteArrayData data[4];
    char stringdata[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_J_ClippingPath_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_J_ClippingPath_t qt_meta_stringdata_J_ClippingPath = {
    {
QT_MOC_LITERAL(0, 0, 14), // "J_ClippingPath"
QT_MOC_LITERAL(1, 15, 9), // "setActive"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 4) // "clip"

    },
    "J_ClippingPath\0setActive\0\0clip"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_J_ClippingPath[] = {
...
void J_ClippingPath::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        J_ClippingPath *_t = static_cast<J_ClippingPath *>(_o);
        switch (_id) {
        case 0: _t->setActive((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->clip(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (J_ClippingPath::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&J_ClippingPath::setActive)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject J_ClippingPath::staticMetaObject = {
    { &FigureToolInterface::staticMetaObject, qt_meta_stringdata_J_ClippingPath.data,
      qt_meta_data_J_ClippingPath,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *J_ClippingPath::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *J_ClippingPath::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_J_ClippingPath.stringdata))
        return static_cast<void*>(const_cast< J_ClippingPath*>(this));
    if (!strcmp(_clname, "InterfacePlugin"))
        return static_cast< InterfacePlugin*>(const_cast< J_ClippingPath*>(this));
    if (!strcmp(_clname, "com.Tailer.MultiFusion.FigureToolInterface/1.0"))
        return static_cast< FigureToolInterface*>(const_cast< J_ClippingPath*>(this));
    if (!strcmp(_clname, "com.alxn1.DocWindow.PluginInterface/1.0"))
        return static_cast< InterfacePlugin*>(const_cast< J_ClippingPath*>(this));
    return FigureToolInterface::qt_metacast(_clname);
}

int J_ClippingPath::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void J_ClippingPath::setActive(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
