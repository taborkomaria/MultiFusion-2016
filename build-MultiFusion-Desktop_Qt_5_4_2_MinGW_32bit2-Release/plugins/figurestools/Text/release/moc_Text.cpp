...
#include "../../../../../MultiFusion-master/plugins/figurestools/Text/Text.h"
...
struct qt_meta_stringdata_I_Text_t {
    QByteArrayData data[3];
    char stringdata[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_I_Text_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_I_Text_t qt_meta_stringdata_I_Text = {
    {
QT_MOC_LITERAL(0, 0, 6), // "I_Text"
...
static const uint qt_meta_data_I_Text[] = {
...
void I_Text::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        I_Text *_t = static_cast<I_Text *>(_o);
        switch (_id) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (I_Text::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&I_Text::setActive)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject I_Text::staticMetaObject = {
    { &FigureToolInterface::staticMetaObject, qt_meta_stringdata_I_Text.data,
      qt_meta_data_I_Text,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *I_Text::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *I_Text::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_I_Text.stringdata))
        return static_cast<void*>(const_cast< I_Text*>(this));
    if (!strcmp(_clname, "InterfacePlugin"))
        return static_cast< InterfacePlugin*>(const_cast< I_Text*>(this));
    if (!strcmp(_clname, "com.Tailer.MultiFusion.FigureToolInterface/1.0"))
        return static_cast< FigureToolInterface*>(const_cast< I_Text*>(this));
    if (!strcmp(_clname, "com.alxn1.DocWindow.PluginInterface/1.0"))
        return static_cast< InterfacePlugin*>(const_cast< I_Text*>(this));
    return FigureToolInterface::qt_metacast(_clname);
}

int I_Text::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void I_Text::setActive(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
