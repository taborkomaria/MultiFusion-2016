...
#include "../../../MultiFusion-master/paintWidget/ColorBox.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ColorBox_t, stringdata) + ofs \
...
const QMetaObject ColorBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ColorBox.data,
      qt_meta_data_ColorBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ColorBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ColorBox.stringdata))
        return static_cast<void*>(const_cast< ColorBox*>(this));
    if (!strcmp(_clname, "ColorBoxInterface"))
        return static_cast< ColorBoxInterface*>(const_cast< ColorBox*>(this));
    if (!strcmp(_clname, "com.Tailer.MultiFusion.ColorBoxInterface/1.0"))
        return static_cast< ColorBoxInterface*>(const_cast< ColorBox*>(this));
