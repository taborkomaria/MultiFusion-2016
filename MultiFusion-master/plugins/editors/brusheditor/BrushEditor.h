...
class BrushEditor:public BrushEditorInterface, public InterfacePlugin
{
	...
	public:
				...
				texturesList( PATH_TO_TEXTURES )
		{
            ...
            QPushButton *b = new QPushButton(tr("Загрузить текстуру") , ui.textureBrushTab );
            vboxLayout4->addWidget(b);
            connect( b, SIGNAL(clicked(bool)), &texturesList, SLOT(onTextureChoose( bool )));
