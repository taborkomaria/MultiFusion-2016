...
#include "../plugins/editors/brusheditor/TexturesList.h"
class QMainWindow;
class QAction;
...
mainWindow::mainWindow( QWidget *parent):
	manager( "./plugins.xml", this ),processSignals( true )
	{
        ...
        fileToolBar->setStyleSheet("background: rgb(251, 251, 251)");
        fileToolBar->setStyleSheet("padding:5px");
        painter->setStyleSheet("background: rgb(251, 251, 251)");
        //qMenu->setStyleSheet("background: rgb(251, 251, 251)");
        mainMenu->setStyleSheet("color: black;"
                                "background-color: rgb(251, 251, 251);"
                                "selection-background-color: #eef0fc;"
                                "border-style: outset;"
                                "border-width: 1px;"
                                "border-color: #31415a;");
      /*  mainMenu->setStyleSheet("color: black;"
                                "background-color: rgb(251, 251, 251);"
                                "selection-color: #31415a;"
                                "selection-background-color: #eef0fc;"
                                "border-style: outset;"
                                "border-width: 1px;"
                                "border-color: #31415a;");
                                */
       // mainMenu->setStyleSheet("background-color:rgb(251, 251, 251)");
        //mainMenu->setStyleSheet("border:1px solid rgb(0, 0, 0)");
       // fileToolBar->setStyleSheet("QToolButton:!hover {background-color:rgb(251,251,251)} QToolBar {background: rgb(251, 251, 251)}");
...
//        connect( painter, SIGNAL( objectCreated() ), this, SLOT( onObjectCreated() ) );
        ...
        qMenu->setStyleSheet("padding:5px");
        ...
        m_plblX->setStyleSheet("padding:10px");
        m_plblY->setStyleSheet("padding:10px");
        m_plblScale->setStyleSheet("padding:10px");
        /*loadImage = objectMenu->addAction(  tr( "&Загрузить изображение" ) );
        //groupAction->setShortcut( tr( "Ctrl+G" ) );
        loadImage->setIcon( QIcon( ":/main/images/load.png" ) );
        connect( loadImage, SIGNAL( triggered( bool ) ), this, SLOT( onloadImage()));
*/
